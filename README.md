...
- **既知の弱点クエリ（隠さず指標に残す）**: ドロー系（0.37〜0.59）とコンボ（0.60）。「引く」を構造化した列がまだ無く、候補生成と順位づけが残る課題（除去系は 2026-07 の集中改修で解決済み）。緩い採点なら高く出るが、その数字に意味はないと判断している。
...
| 評価 GT（3 段階 relevance・人手採点） | 1,532 採点ペア / 34 クエリ |
