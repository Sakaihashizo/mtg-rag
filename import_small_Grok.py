# import_small.py （SMALLモデル専用・バッチ処理版）
import ijson
import json
...
# ==================== 設定 ====================
MODEL_NAME = 'intfloat/multilingual-e5-small'   # 384次元
...
TABLE_CARDS = "mtg_cards_small"
TABLE_EMBED = "mtg_embeddings_small"
# =============================================

print("【SMALLモデル 384次元】ロード中...")
...
print("MTGカード取り込み開始...（SMALLモデル・バッチ処理）")
...
with open(JSON_FILE, 'r', encoding='utf-8') as f:
    ...
    for card_data in tqdm(cards, desc="SMALL処理中", mininterval=20):
...
print(f"\n🎉 SMALLモデル取り込み完了！ 処理したカード数: {count:,} 枚")