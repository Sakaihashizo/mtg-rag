...
入力: 「1マナのマナクリーチャー」
出力: {{"search_query": "マナを生むクリーチャー", "hyde_text": "Creature. {{T}}: Add one mana of any color.", "tournament_boost": false, "removal_mode": false, "counter_mode": false, "type_filter": "Creature", "cmc_min": 1, "cmc_max": 1}}
