...
def rewrite_query(query: str, api_key: str) -> tuple[str, str, bool, bool, bool, str | None]:
    ...
    try:
        ...
        return search_query, hyde_text, tournament_boost, removal_mode, counter_mode, type_filter
    except Exception:
...
def process_question(searcher, question, fmt, top_k, api_key,
    ...
    if use_rewrite:
        ...
        search_query, hyde_text, tournament_boost, removal_mode, counter_mode, type_filter = rewrite_query(
            question, api_key
        )
        flags = []
